...
def test_evaluation():
    print("正在准备测试 Evaluation Extractor...")
    db = SessionLocal()
    try:
        ...
        result = evaluation_service.extract_metadata(context=context, document_id=doc.id)
