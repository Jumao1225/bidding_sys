...
export function EngineeringCard({ engineering = {} }: EngineeringProps) {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm p-6 rounded-3xl shadow-sm border border-amber-100 flex flex-col group hover:shadow-md transition-all h-[400px] overflow-hidden">
      <div className="flex items-center gap-3 mb-4 shrink-0">
        <span className="p-2 bg-amber-100 text-amber-600 rounded-lg">🏗️</span>
        <h3 className="text-slate-700 font-bold tracking-wide">施工痛点与技术防线</h3>
      </div>
